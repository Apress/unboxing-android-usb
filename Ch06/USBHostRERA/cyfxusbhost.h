...
#define PROD_EVENT (1 << 0)
CyU3PEvent glDMAEvent;
CyU3PDmaChannel glHostAoACh, glI2SRightCh, glI2SLeftCh;                  /* DMA channel for mouse application. */

uint32_t prodCount, consCount, bufCount;
uint32_t lc, rc;
...
#define CY_FX_HOST_VBUS_DISABLE_VALUE   (!CY_FX_HOST_VBUS_ENABLE_VALUE) /* GPIO value for disabling VBUS. */
